 ...
 * @internal
 */
final readonly class AuthenticationSpecificationImpl implements AuthenticationSpecification
{
    public function __construct(public RequestSpecification $requestSpecification)
    {
    }
}
