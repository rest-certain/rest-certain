...
/**
 * You must configure REST Certain using {@see \RestCertain\Config} and
 * {@see \RestCertain\RestCertain::$config} before attempting this operation.
 */
final class MissingConfiguration extends LogicException implements RestCertainException
{
}
