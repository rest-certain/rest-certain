...
final class Matchers
{
     ...
     */
    public static function matchesJsonSchema(Stringable | string $schema): Constraint
    {
        return MatchesJsonSchema::fromString($schema);
    }
     ...
     */
    public static function matchesJsonSchemaFromData(array | object $data): Constraint
    {
        return MatchesJsonSchema::fromData($data);
    }
     ...
     */
    public static function matchesJsonSchemaFromFile(Stringable | string $path): Constraint
    {
        return MatchesJsonSchema::fromFile($path);
    }
     ...
     */
    public static function matchesJsonSchemaFromUri(Stringable | UriInterface | string $uri): Constraint
    {
        return MatchesJsonSchema::fromUri($uri);
    }
}
